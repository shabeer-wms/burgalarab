...
export const KitchenOrderCard: React.FC<KitchenOrderCardProps> = ({
  ...
  // Display order number exactly as it was generated by the waiter (e.g. "ORD001").
  // Kitchen previously converted the order number to numeric only; show the
  // original string so it matches the Waiter UI.
  const getDisplayOrderNumber = (orderNumber: string | undefined): string => {
